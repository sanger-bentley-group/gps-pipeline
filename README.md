...
[![Nextflow](https://img.shields.io/badge/nextflow%20DSL2-22.10.7-23aa62.svg)](https://www.nextflow.io/)
...
## Run
> ⚠️ Docker or Singularity must be running. An Internet connection is required for the first run (if initialisation was not performed).
